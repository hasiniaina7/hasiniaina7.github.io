...
const assets = [
  ...
  { id: 'hasiniaina-portrait', source: 'hasiniaina.png', widths: [320, 480, 720], role: 'portrait', decorative: false, alt: 'Portrait de Hasiniaina Christian LOVANIRINA, ingénieur Full-Stack Senior.', surface: 'light', directory: 'media' },
  { id: 'hasiniaina-portrait-cutout', source: 'imagegen/hasiniaina-portrait-cutout-v2.png', widths: [320, 480, 720], role: 'portrait', decorative: false, alt: 'Portrait de Hasiniaina Christian LOVANIRINA, ingénieur Full-Stack Senior.', surface: 'light', directory: 'media' },
