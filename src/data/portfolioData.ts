...
export type NavigationItem = {
  path: '/' | '/parcours' | '/projets' | '/competences' | '/contact';
  label: string;
};
...
export const seoByPath: Record<NavigationItem['path'], SeoMeta> = {
  '/': {
    ...
    description:
      'Hasiniaina Christian LOVANIRINA conçoit des SaaS B2B, applications terrain, paiements, IA appliquée et infrastructures réseau depuis Madagascar pour des clients Afrique-Europe.',
    canonicalPath: '/',
    ogTitle: 'Hasiniaina Christian LOVANIRINA - Ingénieur Full-Stack Senior B2B',
    ogDescription: 'Systèmes fiables pour opérations réelles: SaaS B2B, applications terrain, paiements, IA appliquée et infrastructure réseau.',
  },
  '/parcours': {
  ...
  '/competences': {
    ...
    description:
      'Compétences organisées autour des opérations à fiabiliser: collecter, synchroniser, payer, tracer, superviser, automatiser et sécuriser.',
    canonicalPath: '/competences',
    ogTitle: 'Compétences - Hasiniaina Christian LOVANIRINA',
    ogDescription: 'Compétences structurées autour des flux métier et des risques opérationnels.',
  },
  '/contact': {
    title: 'Contact - Hasiniaina Christian LOVANIRINA',
    description:
      'Échanger avec Hasiniaina Christian LOVANIRINA pour cadrer, construire, moderniser ou renforcer un système métier fiable.',
...
export const pageCopy = {
  home: {
    ...
    mapSummary: 'Madagascar comme base opérationnelle, des clients en Afrique, et une collaboration possible avec des équipes Europe.',
    featuredProjectIds: ['tz-smart', 'ai-commerce-orchestrator', 'fretunia-trackmada', 'aim-madagascar'] satisfies ProjectId[],
    principlesSummary: 'Le bon choix technique est celui que les équipes peuvent utiliser, maintenir et contrôler.',
  },
  parcours: {
    eyebrow: 'Trajectoire',
  ...
  projets: {
    eyebrow: 'Projets',
    intro: 'Des systèmes construits pour gérer des clients, des paiements, des conversations, des colis et des équipes terrain.',
  },
  competences: {
    eyebrow: 'Compétences',
    intro: 'Les compétences sont organisées autour de ce que vos opérations doivent faire: collecter, synchroniser, payer, tracer, superviser, automatiser et sécuriser.',
  },
  contact: {
    eyebrow: 'Contact',
    intro: 'Parlez-moi de vos contraintes: système à cadrer, application à livrer, outil à moderniser ou équipe à renforcer.',
    interventionDomains: ['SaaS B2B', 'applications terrain', 'paiements et audit', 'IA appliquée', 'infrastructure réseau', 'modernisation métier'],
  },
} as const;
