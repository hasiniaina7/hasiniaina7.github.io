...
export const blueprintFlows: BlueprintFlow[] = [
  ...
  { id: 'mobile-local', from: 'mobile-app', to: 'local-storage', label: 'Offline first', accent: 'green' },
...
export const blueprintModules: BlueprintModule[] = [
  {
    ...
    accent: 'green',
    steps: ['Offline first', 'SQLite', 'API Rest', 'Sync serveur'],
    status: 'operational',
    evidenceLevel: 'derived-from-cv',
  },
  {
    ...
    accent: 'blue',
    steps: ['Request', 'Tenant routing', 'RLS', 'Admin control'],
    status: 'verified',
    evidenceLevel: 'derived-from-cv',
  },
  {
...
export const works: WorkItem[] = [
  ...
  },
  {
    ...
    stack: ['Next.js', 'TypeScript', 'PostgreSQL', 'RLS', 'RBAC', 'n8n', 'OpenAI API', 'Webhooks', 'PWA'],
  ...
  },
  {
    ...
    summary: "Site web full-stack fullstack, que j'ai créé en toute autonomie : conception, réalisation, test et déploiement",
  ...
  },
  {
    ...
    categories: ['web'],
    categoryLabel: 'Réalisation web full-stack',
    summary: "Site web logistique Site web fullstack, que j'ai créé en toute autonomie, conception, realisation, test et deployement",
  ...
  },
  {
    ...
    categories: ['web'],
    categoryLabel: 'Réalisation web full-stack',
    summary: "Site web fullstack, que j'ai créé en toute autonomie, conception, realisation, test et deployement",
...
export const pageCopy = {
  home: {
    ...
    productionSitesSummary: 'Cette section vous montre Trois de mes recente réalisations de sites web qui sont en production et accessibles publiquement.',
